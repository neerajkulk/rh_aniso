...
/* ------- begin -------------------------- readreJ21lambda.c --------- */

void readreJ21lambda(int nspect, double *reJ21)
{
  const char routineName[] = "readreJ21lambda";
  ...
  result &= (pread(spectrum.fd_reJ21, reJ21,
		   recordsize, offset) == recordsize);
...
/* ------- end ---------------------------- readreJ21lambda.c --------- */



/* ------- begin -------------------------- readimJ21lambda.c --------- */

void readimJ21lambda(int nspect, double *imJ21)
{
  const char routineName[] = "readimJ21lambda";
  ...
  result &= (pread(spectrum.fd_imJ21, imJ21,
		   recordsize, offset) == recordsize);
...
/* ------- end ---------------------------- readimJ21lambda.c --------- */



/* ------- begin -------------------------- readreJ22lambda.c --------- */

void readreJ22lambda(int nspect, double *reJ22)
{
  const char routineName[] = "readreJ22lambda";
  ...
  result &= (pread(spectrum.fd_reJ22, reJ22,
		   recordsize, offset) == recordsize);
...
/* ------- end ---------------------------- readreJ22lambda.c --------- */




/* ------- begin -------------------------- readimJ22lambda.c --------- */

void readimJ22lambda(int nspect, double *imJ22)
{
  const char routineName[] = "readimJ22lambda";
  ...
  result &= (pread(spectrum.fd_imJ22, imJ22,
		   recordsize, offset) == recordsize);
...
/* ------- begin -------------------------- writereJ21lambda.c -------- */

void writereJ21lambda(int nspect, double *reJ21)
{
  const char routineName[] = "writereJ21lambda";
  ...
  result &= (pwrite(spectrum.fd_reJ21, reJ21,
		    recordsize, offset) == recordsize);
...
/* ------- end ---------------------------- writereJ21lambda.c -------- */


/* ------- begin -------------------------- writeimJ21lambda.c -------- */

void writeimJ21lambda(int nspect, double *imJ21)
{
  const char routineName[] = "writeimJ21lambda";
  ...
  result &= (pwrite(spectrum.fd_imJ21, imJ21,
		    recordsize, offset) == recordsize);
...
/* ------- end ---------------------------- writeimJ21lambda.c -------- */


/* ------- begin -------------------------- writereJ22lambda.c -------- */

void writereJ22lambda(int nspect, double *reJ22)
{
  const char routineName[] = "writereJ22lambda";
  ...
  result &= (pwrite(spectrum.fd_reJ22, reJ22,
		    recordsize, offset) == recordsize);
...
/* ------- end ---------------------------- writereJ22lambda.c -------- */


/* ------- begin -------------------------- writeimJ22lambda.c -------- */

void writeimJ22lambda(int nspect, double *imJ22)
{
  const char routineName[] = "writeimJ22lambda";
  ...
  result &= (pwrite(spectrum.fd_imJ22, imJ22,
		    recordsize, offset) == recordsize);
